...
acf_add_local_field_group(array(
    'key' => 'group_get_started_today',
    'title' => 'Get Started Today Block',
    'fields' => array(
        array(
            'key' => 'field_get_started_heading',
            'label' => 'Heading',
        ...
        array(
            'key' => 'field_get_started_description',
            'label' => 'Description',
...
add_filter('acf/load_field/name=get_started_cf7_form', function($field) {
