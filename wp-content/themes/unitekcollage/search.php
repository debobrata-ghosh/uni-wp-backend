    ...
    <div class="container">
        <header class="page-header">
            <h1 class="page-title">
                ...
                printf(
                    ...
                    esc_html__('Search Results for: %s', 'unitek-college'),
        ...
        <?php else : ?>
            <div class="no-posts">
                ...
                <p><?php _e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'unitek-college'); ?></p>
                <?php get_search_form(); ?>
            </div>
        <?php endif; ?>
    </div>
